...
// UNION, UNION ALL
{
   ...
   const query = `${pokemons.query} UNION ALL ${artificialPokemons.query};`;
   const params = [...pokemons.params, ...artificialPokemons.params];
   // Note that "execute" is an original "mysql2" function
   const [allPokemons] = await mysql2.execute(query, params);
